import vs from './edge.vert';
import fs from './edge.frag';
 ...
 */
export default class EdgeRenderer extends PIXI.ObjectRenderer
{
    /**
...
PIXI.WebGLRenderer.registerPlugin('edge-container', EdgeRenderer);
